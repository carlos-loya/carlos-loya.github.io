// Vendored from ReactBits (ts-tailwind variant): https://reactbits.dev/animations/logo-loop
// Self-contained — no external dependencies beyond React. Do not edit lightly.
